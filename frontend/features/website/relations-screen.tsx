          ...
          {friendsQuery.isLoading ? (
            ...
            <div className="mt-6 space-y-3">
              {(friendsQuery.data ?? []).map((friend) => (
                <div key={friend.id} className="flex items-center gap-3 rounded-[24px] bg-[#FAF5EF] px-4 py-4">
                  <Link
              ...
              {!friendsQuery.data?.length ? (
                <div className="rounded-[24px] bg-[#FAF5EF] px-4 py-5 text-sm text-graphite">
          ...
          {usersQuery.isLoading ? (
            ...
            <div className="mt-6 space-y-3">
              {suggestedAccounts.map((entry) => (
                <div key={entry.id} className="flex items-center gap-3 rounded-[24px] bg-[#FAF5EF] px-4 py-4">
                  <Link
