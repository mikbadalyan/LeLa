  ...
  return (
    <div className="mx-auto flex min-h-[calc(100dvh-10rem)] w-full max-w-[1380px] items-center px-5 py-10 lg:px-8">
      <div className="grid w-full gap-6 lg:grid-cols-[0.95fr_0.9fr]">
        <div className="overflow-hidden rounded-[40px] bg-[linear-gradient(150deg,#201B27_0%,#6A2BE8_100%)] px-8 py-10 text-white shadow-card">
        ...
        <div className="rounded-[40px] bg-white px-6 py-6 shadow-card ring-1 ring-black/5 sm:px-8 sm:py-8">
